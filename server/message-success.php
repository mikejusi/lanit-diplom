        ...
        <main>
            <div class="w-50 mx-auto my-5">
                <div class="alert alert-success" role="alert">
                    ...
                    <p>Ваш отзыв успешно отправлен и получил статус в обработке. Если он не нарушает правила сайта, его обязательно опубликуют. Ожидайте</p>
                    <hr>
                    <strong><a class="alert__success text-decoration-underline" href="../index.php"><p class="mb-0">Вернуться на главную страницу.</p></a></strong>
                </div>
            </div>
