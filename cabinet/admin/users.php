...
<div class="wrapper">
 ...
 <div class="main-container">
  <div class="header">
   ...
   <a class="header-link" href="users-del.php">
  ...
  <div class="main">
    ...
    <table class="table text-white table__custom" id="table" 
       ...
       <thead>
            ...
            <th scope="col" data-field="email" data-filter-control="select" data-sortable="true">Email</th>
            <th scope="col" data-field="name" data-filter-control="input" data-sortable="true">Имя пользователя</th>
            <th scope="col" data-field="date" data-filter-control="input" data-sortable="true">Когда был создан</th>
            </tr>
        </thead>
        <tbody>
