...
<div class="wrapper">
  ...
  <div class="main-container">
    ...
    <a class="header-link" href="review-pub.php">
  ...
  <div class="main">
    ...
    <table class="table text-white table__custom" id="table" 
       ...
       <thead>
            ...
            <th scope="col" data-field="date" data-filter-control="input" data-sortable="true">Текст</th>
            <th scope="col" data-field="email" data-filter-control="select" data-sortable="true">Статус</th>
            </tr>
        </thead>
        <tbody>
