...
<div class="wrapper">
 ...
 <div class="main-container">
  ...
  <a href="../../index.php"><div class="logo">ЛАНИТ</div></a>
   ...
   <a class="header-link active" href="message.php">
   ...
   <a class="header-link" href="message-add.php">
  ...
  <div class="main">
      ...
      <table class="table text-white table__custom" id="table" 
        ...
        <thead>
              ...
              <th scope="col" data-field="email" data-filter-control="select" data-sortable="true">Имя пользователя</th>
              <th scope="col" data-field="date" data-filter-control="input" data-sortable="true">Сообщение</th>
              </tr>
          </thead>
          <tbody>
              <?php foreach ($ms as $mes) : ?>
                  <tr>
                  <td><?= $mes['id'];?></td>
                  <td><?= $mes['name'];?></td>
                  <td><?= $mes['message'];?></td>
