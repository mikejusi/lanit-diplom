    ...
    <div class="wrapper">
        ...
        <main>
            <div class="container py-4">
                ...
                <div class="d-flex flex-wrap justify-content-center worker-container">

                    <?php foreach ($sotr as $sotrudniki) : ?>
                        <div class="card worker" style="width: 18rem;">
                            <div class="p-2">
                                <img class="w-100 rounded" src="assets/img/worker/<?= $sotrudniki['img'];?>">
                            </div>
                            <h4 class="text-center mt-2"><?= $sotrudniki['name'];?></h4>
                            <p class="text-center"><?= $sotrudniki['jobtitle'];?></p>
                            <div class="social__work d-flex justify-content-center gap__work">

                                <a href="<?= $sotrudniki['vk'];?>">
                                    <div class="p-2 box-shadow-work rounded">
                                        <i class="fa-brands fa-vk"></i>
                                    </div>
                                </a>

                                <a href="<?= $sotrudniki['tg'];?>">
                                    <div class="p-2 box-shadow-work rounded">
                                        <i class="fa-brands fa-telegram"></i>
                                    </div>
                                </a>

                                <a href="<?= $sotrudniki['git'];?>">
                                    <div class="p-2 box-shadow-work rounded">
            ...
            <blockquote class="pullquote"><h4>Последний отзыв</h4>"<?= $otz['text']; ?>" &mdash; Username</blockquote>
            <?php endforeach; ?>
