...
<body>
    ...
    <div class="wrapper">
        ...
        <main class="container">
            <form class='mt-4 d-grid justify-content-center' action='server/buy.php' method='POST' autocomplete='off'>
                <input name='message' placeholder='Email' type='text' class='form-control text-box mb-3' id='exampleFormControlInput1' contenteditable='true'>
                <input name='message' placeholder='Ваше имя' type='text' class='form-control text-box mb-3' id='exampleFormControlInput1' contenteditable='true'>
                <button class="btn btn-success" type='submit' id='sendMessage'>Купить</button>
            </form>
        </main>
